             ...
             TPrimaryHeaderContainer(
              child: Column(
                ...
                children: [
                  ...
                  /// -- Searchbar
                  TSearchContainer(text: TTexts.searchInStore.tr, showBorder: false),
                  SizedBox(height: TSizes.spaceBtwSections),
                  ...
                  Obx(
                    () {
                      ...
                      if (controller.featuredProducts.isEmpty) {
                        return Center(child: Text(TTexts.noDataFound.tr, style: Theme.of(context).textTheme.bodyMedium));
                      } else {
