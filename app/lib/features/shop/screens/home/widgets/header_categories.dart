  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          /// -- Heading
          TSectionHeading(title:TTexts.popularCategories.tr, textColor: TColors.white, showActionButton: false),
          ...
          Obx(
            () {
              ...
              if (categoryController.featuredCategories.isEmpty) {
                return Center(
                    child:
                        Text(TTexts.noDataFound.tr, style: Theme.of(context).textTheme.bodyMedium!.apply(color: Colors.white)));
              } else {
                /// Data Found
