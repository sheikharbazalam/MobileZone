...
class ChatModel {
  ...
  factory ChatModel.empty() =>
      ChatModel(id: '', participants: [], participantIds: [], lastMessageTime: DateTime.now(), chatType: ChatType.support, referenceId: '');
  ...
  factory ChatModel.fromFirestore(DocumentSnapshot doc) {
    ...
    return ChatModel(
      ...
      chatType: data.containsKey('chatType') ? chatTypeFromString(data['chatType']) : ChatType.support,
      // Default to 'ride'
