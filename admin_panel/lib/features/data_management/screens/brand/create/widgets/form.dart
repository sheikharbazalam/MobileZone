...
class CreateBrandForm extends StatelessWidget {
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            const TTextWithIcon(text: 'Create new Brand', icon: Iconsax.dcube),
  ...
  TContainer _chooseCategories(CreateBrandController controller) {
    return TContainer(
      width: double.infinity,
                ...
                Row(
                  ...
                  children: [
                    ...
                    TChoiceChip(
                      ...
                      selected: controller.selectedCategories.contains(parentCategory),
                        ...
                        Wrap(
                          ...
                          children: controller.categoryController.allItems
                              ...
                              .map((childCategory) => TChoiceChip(
                                    ...
                                    selected: controller.selectedCategories.contains(childCategory),
