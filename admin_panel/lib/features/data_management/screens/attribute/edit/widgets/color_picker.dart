...
class ColorPickerEdit extends StatelessWidget {
  const ColorPickerEdit({
    super.key,
  });

  @override
  Widget build(BuildContext context) {
    final controller = EditAttributeController.instance;
    return TFormContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton.icon(onPressed: () => controller.addColorToList(), icon: Icon(Iconsax.add), label: Text('Add Color')),
