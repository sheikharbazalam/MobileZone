        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              /// Heading
              TTextWithIcon(text: TTexts.updateAttribute.tr, icon: Iconsax.activity),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: Tooltip(
                    message: TTexts.attributeNameTooltip.tr,
                  ...
                  return SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: Tooltip(
                          message: TTexts.attributeValuesTooltip.tr,
                          child: Icon(Iconsax.info_circle, color: Colors.grey),
                        ),
                      ),
                    ),
                  ...
                  Expanded(
                    child: Obx(
                      () => CheckboxMenuButton(
                        ...
                        trailingIcon: Tooltip(
                          message: TTexts.searchableTooltip.tr,
                          child: Icon(Iconsax.info_circle, color: Colors.grey),
                        ),
                  ...
                  Expanded(
                    child: Obx(
                      () => CheckboxMenuButton(
                        ...
                        trailingIcon: Tooltip(
                          message: TTexts.sortableTooltip.tr,
                          child: Icon(Iconsax.info_circle, color: Colors.grey),
                        ),
                  ...
                  child: controller.isLoading.value
                      ...
                      : SizedBox(
                          ...
                          child: ElevatedButton(
                              onPressed: () => controller.updateAttribute(controller.attribute.value),
                              child: Text(TTexts.update.tr)),
                        ),
                ),
              ),
              SizedBox(height: TSizes().spaceBtwInputFields * 2),
