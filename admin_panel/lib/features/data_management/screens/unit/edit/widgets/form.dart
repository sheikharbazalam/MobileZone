...
class EditUnitForm extends StatelessWidget {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const TTextWithIcon(text: 'Update Unit', icon: Iconsax.unlimited),
                ...
                () => AnimatedSwitcher(
                  ...
                  child: controller.isLoading.value
                      ...
                      : SizedBox(
                          ...
                          child: ElevatedButton(onPressed: () => controller.updateUnit(controller.unit.value), child: const Text('Create')),
                        ),
                ),
              ),
              SizedBox(height: TSizes().spaceBtwInputFields * 2),
  ...
  Widget _customDropdown(EditUnitController controller) {
    return Obx(
      () => controller.isLoading.value
          ...
          : TDropdown<UnitType>(
              ...
              items: (query, _) async {
                ...
                return UnitType.values.where((unit) => unit.name.toLowerCase().contains(query.toLowerCase())).toList();
              },
              ...
              noResultsText: "No unit types found",
