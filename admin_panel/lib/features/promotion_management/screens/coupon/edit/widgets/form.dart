...
class EditCouponForm extends StatelessWidget {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              /// Heading
              TTextWithIcon(text: TTexts.updateCoupon.tr, icon: Iconsax.activity),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: TTexts.discountValue.tr,
                  ...
                  child: controller.isLoading.value
                      ...
                      : SizedBox(
                          ...
                          child: ElevatedButton(
                              onPressed: () => controller.updateCoupon(controller.coupon.value), child: Text(TTexts.update.tr)),
                        ),
                ),
              ),
              SizedBox(height: TSizes().spaceBtwInputFields * 2),
  ...
  Future<void> _startDateTimeRangePicker(BuildContext context, EditCouponController controller) async {
  ...
  Future<void> _endDateTimeRangePicker(BuildContext context, EditCouponController controller) async {
    DateTime? dateTime = await showOmniDateTimePicker(
      context: context,
      constraints: const BoxConstraints(maxWidth: 600, maxHeight: 600),
      padding: EdgeInsets.all(TSizes().defaultSpace),
