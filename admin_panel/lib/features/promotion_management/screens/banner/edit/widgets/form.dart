...
class EditBannerForm extends StatelessWidget {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                /// Heading
                TTextWithIcon(text:TTexts.updateBanner.tr, icon: Iconsax.activity),
                    ...
                    child: controller.isLoading.value
                        ...
                        : SizedBox(
                            ...
                            child: ElevatedButton(
                                onPressed: () => controller.updateBanner(controller.banner.value), child: Text(TTexts.update.tr)),
                          ),
                  ),
                ),
                SizedBox(height: TSizes().spaceBtwInputFields * 2),
  ...
  Future<void> _startDateTimeRangePicker(BuildContext context, EditBannerController controller) async {
  ...
  Future<void> _endDateTimeRangePicker(BuildContext context, EditBannerController controller) async {
    DateTime? dateTime = await showOmniDateTimePicker(
      context: context,
      constraints: const BoxConstraints(maxWidth: 600, maxHeight: 600),
      padding: EdgeInsets.all(TSizes().defaultSpace),
