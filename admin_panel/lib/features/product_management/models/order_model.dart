...
import '../../promotion_management/models/coupon_model.dart';
...
class OrderModel {
  ...
  double calculateSubTotal() {
    return products.fold(0.0, (previous, product) =>previous + ((product.salePrice == 0 ? product.price : product.salePrice)  * product.quantity)
    );
  }
