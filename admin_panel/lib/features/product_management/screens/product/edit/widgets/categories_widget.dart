    ...
    return TContainer(
      child: Column(
        ...
        children: [
          ...
          Obx(() => EditProductController.instance.selectedCategories.isNotEmpty
              ? Wrap(
                  spacing: TSizes().sm,
                  runSpacing: TSizes().sm,
                  children: EditProductController.instance.selectedCategories
                      // .where((category) => category.parentId.isEmpty)
                      .map((parentCategory) {
                    return Chip(
                      backgroundColor: Colors.white,
                      label: Text(parentCategory.name),
                      onDeleted: () => EditProductController.instance.selectedCategories.remove(parentCategory),
                          ...
                          Row(
                            children: [
                              ...
                              TChoiceChip(
                                ...
                                selected: EditProductController.instance.selectedCategories.contains(parentCategory),
                                onSelected: (value) => EditProductController.instance.toggleCategories(parentCategory),
                              ),
                            ],
                          ),
                          // Child categories
                                  ...
                                  children: [
                                    ...
                                    Wrap(
                                      ...
                                      children: categoryController.allItems
                                        ...
                                        selected: EditProductController.instance.selectedCategories
                                            .contains(childCategory),
                                        onSelected: (value) =>
                                            EditProductController.instance.toggleCategories(childCategory),
                                      ))
                                          .toList(),
                                    ),
                                  ],
